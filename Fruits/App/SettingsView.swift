            ...
            ScrollView(.vertical, showsIndicators: false) {
                VStack(spacing: 20) {
                    ...
                    GroupBox(label: SettingsLabelView(labelText: "Application", labelImage: "apps.iphone")) {
                        ...
                        SettingsRowView(leadingText: "Designer", trailingText: "Robert Petras")
                        SettingsRowView(leadingText: "Compatibility", trailingText: "iOS 14")
                        SettingsRowView(leadingText: "Website", linkLabel: "SwiftUI Masterclass" , linkDestination: "swiftuimasterclass.com")
                        SettingsRowView(leadingText: "Twitter", linkLabel: "@RobertPetras", linkDestination: "twitter.com/robertpetras")
                        SettingsRowView(leadingText: "SwiftUI", trailingText: "2.0")
                        SettingsRowView(leadingText: "Version", trailingText: "1.1.0")
